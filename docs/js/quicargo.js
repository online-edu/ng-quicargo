...
(function() {
  "use strict";
  angular.module("quicargo").factory("dashboardService", function($q, $http) {
    return {
...
(function() {
  ...
  angular.module("quicargo").component("sidenav", {
    ...
    controller: function SidenavController($route) {
      ...
      this.navItems = [
        { link: "dashbaord", title: "New Delivery", disabled: false },
        {
          link: "deliveries",
          title: "My Deliveries",
          count: 2,
        ...
        { link: "history", title: "History", count: 4, disabled: true }
      ];
      /**
